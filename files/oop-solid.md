...
Высокоуровневый Модуль(или класс): Класс, выполняющий действие с помощью инструмента.  
...
* **_Принцип единственной ответственности_** - создание классов, которые отвечают сразу за несколько функций:
1. God object - все и сразу.  
2. Singleton - потому что отвечает помимо основной функции за свою уникальность / единственность.  
